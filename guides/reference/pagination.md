...
Параметры-списки принимают `maxPages` — предохранитель от бесконечного перебора (по умолчанию
1000). Перебор также сам останавливается на пустой странице, неизменившемся или отсутствующем
курсоре.
