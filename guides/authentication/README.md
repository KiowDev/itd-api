...
Капча участвует ровно в одном шаге — входе по паролю. Продление, обычные запросы и realtime
...
Капча нужна **только в момент входа**. Продление сессии, любой обычный запрос и realtime
